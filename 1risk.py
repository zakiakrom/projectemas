...
with st.sidebar:
    ...
    st.button("📈 Trending", use_container_width=True)
    st.button("🌐 Region Analysis", use_container_width=True)
    st.button("⚠️ Risk Prediction", type="primary", use_container_width=True)
    
    st.divider()
    st.write("System Integrity")
    st.progress(94, text="94% Stability")
